...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/SDWebImage/libvmaf-Xcode.git", "2.2.0"..<"2.3.1")
    ],
    targets: [
        ...
        .target(
            ...
            exclude: [
                ...
                "aom/aom_scale/mips", "aom/av1/encoder/mips", "aom/aom_ports/ppc_cpudetect.c",
                "aom/aom_ports/riscv_cpudetect.c", "aom/av1/decoder/inspection.c",
                "aom/av1/encoder/tune_butteraugli.c", "aom/av1/encoder/arm/av1_error_sve.c",
                "aom/av1/encoder/arm/highbd_pickrst_sve.c", "aom/av1/encoder/arm/pickrst_sve.c",
                "aom/av1/encoder/arm/wedge_utils_sve.c", "aom/av1/common/arm/convolve_sve2.c",
                "aom/av1/common/arm/highbd_compound_convolve_sve2.c",
                "aom/av1/common/arm/highbd_convolve_sve2.c", "aom/av1/common/arm/highbd_warp_plane_sve.c",
                "aom/av1/common/arm/warp_plane_sve.c", "aom/aom_dsp/arm/aom_neon_sve_bridge.h",
